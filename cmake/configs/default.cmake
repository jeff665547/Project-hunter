...
hunter_default_version(ARPACK-NG VERSION 3.5.0-p1)
...
hunter_default_version(ChipImgProc VERSION 0.0.4)
...
hunter_default_version(Nucleona VERSION 0.0.4)
...
if(MINGW)
  # a build bug workaround
  hunter_default_version(OpenCV VERSION 3.4.0-p0)
else()
...
hunter_default_version(Screw VERSION 0.0.1)
...
<<<<<<< HEAD
hunter_default_version(armadillo VERSION 8.200.x-px)
=======
hunter_default_version(armadillo VERSION 8.200.x-p1)
>>>>>>> 341fa265309986b6a76bc721e45a7b373e970dbc
...
hunter_default_version(hdf5 VERSION 1.10.2-h0)
